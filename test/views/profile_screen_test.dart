...
void main() {
  group('ProfileScreen', () {
    testWidgets('displays initial UI elements correctly',
      ...
      await tester.pumpWidget(appWithCart(Cart(), profileScreen));

      // AppBar exposes cart indicator
    ...
    testWidgets('trims whitespace from input fields',
      ...
      await tester.pumpWidget(appWithCart(Cart(), host));
