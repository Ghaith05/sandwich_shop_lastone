...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _processPayment() async {
    ...
    try {
      if (kIsWeb) {
        // sqflite is not supported on web — skip persistence and log for debugging.
        debugPrint('Running on web: skipping local SQLite insert.');
      } else {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Could not save order locally: $e')),
        );
      }
    } finally {
      if (mounted) {
